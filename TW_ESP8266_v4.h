 ...
 *          STANDARD ENUMS
 */
// Enum for Normal Operation of Device
typedef     enum    _nDeviceState{
            _BRN_NON_INITIALIZED,
            _BRN_START,
            _BRN_RDY,
            _BRN_RDY_GET,
            _BRN_ERR_WIFI_ERROR,
            ...
            _BRN_GET_SUCCESS,
            _BRN_GET_ERR,
            _BRN_GET_ERR_WIFI_REBOOT,
            _BRN_SET_REQ,
            _BRN_SET_SUCCESS,
            _BRN_SET_ERR,
            _BRN_EEP_BKP_REQ,
            _BRN_EEP_BKP_SUCCESS,
            _BRN_EEP_BKP_ABORT,
            _BRN_EEP_RES_REQ,
            _BRN_EEP_RES_SUCCESS,
            _BRN_EEP_RES_ABORT,
            _BRN_SRVR_DATA_PARSE_REQ,
            _BRN_SRVR_DATA_PARSE_SUCCESS,
            _BRN_SRVR_DATA_PARSE_FAIL,
            _BRN_LOAD_UPDATE_REQ,
            _BRN_LOAD_UPDATE_SUCCESS,
            _BRN_LOAD_UPDATE_FAIL,
            _BRN_UNABLE_TO_SET_WIFI_CREDS,
            _BRN_INVALID_WIFI_SSID,
            _BRN_INVALID_WIFI_PSWD,
            _BRN_WIFI_CONNECT_RETRY_TIMEOUT_ERR
...
extern                      esp8266StateMachines    _createTcpClient(esp8266StateMachines , const char* ,uint16_t );
extern                      nStates                _genericProvisionAndConnectEsp01(nStates ,const char * ,  const char * , const int , bool );
